...
<body class="easyui-layout">
	<div class="easyui-layout" style="width: 100%; height: 100%;">
		<div data-options="region:'north'"
			style="overflow: hidden; height: 120px; background: url('logincss/img/backgrounds/nav.jpg');">
			<h2
				style="margin-left: 30px; color: black; float: left; margin: 1.5%;">敬老院用工管理系统</h2>
			<div id="right" style="float: right">
				<p id="ptime" style="float: right"></p>
				<span style="float: left">当前用户：管理员${sessionScope.username}</span> <a
					href=${pageContext.request.contextPath}>&nbsp;&nbsp;&nbsp;注销</a>
				<!-- 				<input type="button"
			...
			<div class="easyui-accordion" style="width: 200px; height: 100%;">
				...
				<div title="职位管理" data-options="iconCls:'icon-filter'"
					...
					<button id="btn_selectJob" class="btn_nav easyui-linkbutton"
						data-options="iconCls:'icon-search'" style="width: 80%">岗位查询</button>
					<button id="btn_addJob" class="btn_nav easyui-linkbutton"
						data-options="iconCls:'icon-add'" style="width: 80%">添加岗位</button>
				</div>
				<div title="雇工管理" data-options="iconCls:'icon-man'"
					style="padding: 10px;">
					<button id="btn_selectEmployee" class="btn_nav easyui-linkbutton"
						data-options="iconCls:'icon-search'" style="width: 80%">雇工查询</button>
					<button id="btn_addEmployee" class="btn_nav easyui-linkbutton"
						data-options="iconCls:'icon-add'" style="width: 80%">添加雇工</button>
				</div>
